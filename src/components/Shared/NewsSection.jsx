    ...
    return (
        <div className='flex flex-col gap-5 p-5 items-center md:p-10 md:gap-10 lg:p-16 lg:gap-15'>
            ...
            <div className='flex flex-col justify-between items-center gap-5 lg:gap-10 lg:flex-row'>
                <Link href="https://www.petmd.com/dog/general-health/whelping" target="_blank" rel="noopener noreferrer">
                    <div>
                        <Image
                            src="/whelping.jpg"
                            alt="whelping"
                ...
                <Link href="https://www.petmd.com/cat/nutrition/wet-cat-food-vs-dry-cat-food-which-better" target="_blank" rel="noopener noreferrer">
                    <div>
                        <Image
                            src="/catNews.jpg"
                            alt="whelping"
                ...
                <Link href="https://www.petmd.com/bird/conditions/skin/c_bd_Psittacine_beak_and_feather_disease" target="_blank" rel="noopener noreferrer">
                    <div>
                        <Image
                            src="/birdNews.jpg"
                            alt="whelping"
